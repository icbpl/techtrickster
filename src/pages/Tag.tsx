...
export default function Tag() {
  ...
  const formattedTagName = tagName.split(' ')
    .map(word => word.charAt(0).toUpperCase() + word.slice(1))
    .join(' ');

  // For demo purposes, we'll just show all articles when a tag is selected
  // In a real app, you would filter articles by tag
  const tagArticles = mockRecentArticles;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Browsing all articles tagged with {formattedTagName}
          </p>
        </div>
